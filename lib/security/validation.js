...
export function validateKey(key, options = {}) {
    const { maxKeyLength = DEFAULT_MAX_KEY_LENGTH, allowedKeyChars = DEFAULT_ALLOWED_KEY_CHARS, } = options;
 ...
 */
export function validateValueSize(value, options = {}) {
